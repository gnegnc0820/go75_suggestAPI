...
from models.getSuggestWords import getSuggestWords, getKigoWords
from mecab.kToHByMecab import KanjiToH as ktoh, getYomi

import MeCab
import re

def go75api_getwords(IMAGE,SEASON): 
    ...
    suggest_words = getSuggestWords(use_words)
    suggest_kigos = getKigoWords(use_words,SEASON)
